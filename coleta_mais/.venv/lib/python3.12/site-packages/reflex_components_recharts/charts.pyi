...
def sankey_node(fn: Callable) -> Callable[..., Component]: ...
def sankey_link(fn: Callable) -> Callable[..., Component]: ...
...
class SankeyChart(ChartBase):
    ...
    def create(
        ...
        *children,
        ...
        | SankeyData
        | Var[Mapping[str, Any] | SankeyData]
        | None = None,
        margin: Var[dict[str, Any]] | dict[str, Any] | None = None,
        node: Any | Var[Any] | None = None,
        link: Any | Var[Any] | None = None,
        sort: Var[bool] | bool | None = None,
        node_padding: Var[int] | int | None = None,
        node_width: Var[int] | int | None = None,
        link_curvature: Var[float] | float | None = None,
        iterations: Var[int] | int | None = None,
        width: Var[int | str] | int | str | None = None,
        height: Var[int | str] | int | str | None = None,
        style: Sequence[Mapping[str, Any]]
        | Mapping[str, Any]
        ...
        **props,
        ...
        Args:
            *children: The children of the chart component.
            name_key: The key of each node name. Default: "name"
            data_key: The key of each link value. Default: "value"
            data: The source data, including nodes and the weighted links between them.
            margin: The sizes of whitespace around the chart. Default: {"top": 5, "right": 5, "bottom": 5, "left": 5}
            node: The configuration object or custom renderer used to draw nodes.
            link: The configuration object or custom renderer used to draw links.
            sort: Whether to sort nodes on the y-axis or display them in data order.
            node_padding: The padding between nodes.
            node_width: The width of each node.
            link_curvature: The curvature of each link.
            iterations: The number of layout iterations used to position nodes and links.
            width: The width of chart container. String or Integer
            height: The height of chart container.
            style: The style of the component.
            key: A unique key for the component.
